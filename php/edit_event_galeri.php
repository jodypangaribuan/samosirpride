...
if ($id <= 0) {
    header("Location: event_galeri.php");
    exit;
}

$result = mysqli_query($conn, "SELECT * FROM event_galeri WHERE id = $id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error)) {
        $update_query = "UPDATE event_galeri SET nama='$new_nama', deskripsi='$new_deskripsi', gambar='$new_gambar' WHERE id=$id";
        
        if (mysqli_query($conn, $update_query)) {
            header("Location: event_galeri.php?status=success&message=".urlencode("Event Galeri berhasil diperbarui"));
            exit;
        } else {
        ...
        <div class="form-container">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" rows="4" required><?php echo htmlspecialchars($event['deskripsi']); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="current-image">
                        <p>Gambar saat ini:</p>
                        <img src="uploads/<?php echo htmlspecialchars($event['gambar']); ?>" alt="Current Image">
                    </div>
                    <?php endif; ?>
                </div>

                <div class="button-group">
                    <button type="button" class="cancel-btn" onclick="window.location.href='event_galeri.php'">Batal</button>
