        ...
        <div class="content">
            ...
            <div class="main-content">
                <div class="section-header">
                    <h2 class="section-title">Dokumentasi Remaja Naposo</h2>
                    <a href="tambah_remaja_naposo.php" class="btn btn-primary btn-tambah">
                            ...
                            <div class="gallery-card">
                                ...
                                <div class="gallery-actions">
                                    <button class="btn-edit"
                                        onclick="window.location.href='edit_remaja_naposo.php?id=<?php echo $row['id']; ?>'">
    ...
    <script>
        function confirmDelete(id) {
            if (confirm('Apakah Anda yakin ingin menghapus event galeri ini?')) {
                window.location.href = 'remaja_naposo.php?action=delete&id=' + id;
            }
        }
    </script>
</body>
