...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error)) {
        $update_query = "UPDATE galeri SET nama='$new_nama', deskripsi='$new_deskripsi', gambar='$new_gambar' WHERE id=$id";
        ...
        <div class="form-container">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="button-group">
                    <button type="button" class="cancel-btn" onclick="window.location.href='galeri.php'">Batal</button>
