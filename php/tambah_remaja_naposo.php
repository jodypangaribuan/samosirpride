...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["gambar"]["tmp_name"], $target_file)) {
            ...
            echo $user_id;
            $query = "INSERT INTO remaja_naposo (nama, deskripsi, gambar, user_id) 
                      VALUES ('$nama', '$deskripsi', '$new_filename', '$user_id')";

            if (mysqli_query($conn, $query)) {
                header("Location: remaja_naposo.php?status=success&message=" . urlencode("Remaja Naposo berhasil ditambahkan"));
                exit;
            } else {
                $status = "error";
        ...
        <div class="form-container">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="nama" class="required">Nama Remaja Naposo</label>
                    <input type="text" id="nama" name="nama" required>
                </div>
               
                <div class="form-group">
                    <label for="deskripsi" class="required">Deskripsi Remaja Naposo</label>
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='remaja_naposo.php'">
