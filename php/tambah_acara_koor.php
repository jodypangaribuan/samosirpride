...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["gambar"]["tmp_name"], $target_file)) {
            ...
            echo $user_id;
            $query = "INSERT INTO acara_koor (nama, gambar, user_id) 
                      VALUES ('$nama', '$new_filename', '$user_id')";

            if (mysqli_query($conn, $query)) {
                header("Location: acara_koor.php?status=success&message=" . urlencode("Acara Koor berhasil ditambahkan"));
                exit;
            } else {
                $status = "error";
...
<head>
    ...
    <title>Tambah Acara Koor - Admin Gereja</title>
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-camera"></i> Tambah Acara Koor</h2>
        ...
        <div class="form-container">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-danger" onclick="window.location.href='acara_koor.php'">
