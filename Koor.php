...
<body class="corporate">
  <?php include "templates/navigation.php"; ?>
        ...
        <table class="table table-bordered table-striped">
          <thead class="table-warning">
            <tr>
              ...
              <th class="text-center">Waktu Latihan</th>
            </tr>
          </thead>
          <tbody>
            <?php
      ...
      if ($id > 0) {
        ...
        if ($img_data = mysqli_fetch_assoc($img_result)) {
          ...
          if ($stmt->execute()) {
            ...
            if (!empty($img_data['gambar']) && file_exists("php/uploads/acara_koor" . $img_data['gambar'])) {
              unlink("php/uploads/acara_koor" . $img_data['gambar']);
            }
    ...
    <div class="container">
      <h2 class="text-primary">
        <center><strong>Dokumentasi Setiap Acara Koor </strong></center>
      </h2>
        ...
        <?php if (mysqli_num_rows($result) > 0): ?>
          <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <div class="gallery-card">
              <?php
              $imagePath = "php/uploads/acara_koor" . htmlspecialchars($row['gambar']);
